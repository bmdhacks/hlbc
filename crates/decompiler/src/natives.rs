...
pub fn lookup_native(lib: &str, name: &str) -> Option<&'static str> {
    match (lib, name) {
        ...
        // Bytes functions
        ("std", "alloc_bytes") => Some("Bytes.alloc"),
        ("std", "bytes_blit") => Some("Bytes.blit"),
        ("std", "bytes_compare") => Some("Bytes.compare"),
        ("std", "bytes_compare16") => Some("Bytes.compare16"),
        ("std", "bytes_fill") => Some("Bytes.fill"),
        ("std", "bytes_find") => Some("Bytes.find"),
        ("std", "bytes_offset") => Some("Bytes.offset"),
        ("std", "bytes_subtract") => Some("Bytes.subtract"),
        ("std", "bytes_address") => Some("Bytes.getAddress"),
        ("std", "bytes_from_address") => Some("Bytes.fromAddress"),
        ("std", "bsort_i32") => Some("Bytes.sortI32"),
        ("std", "bsort_f64") => Some("Bytes.sortF64"),
        ("std", "hash") => Some("Bytes.hash"),
        ("std", "parse_float") => Some("Bytes.parseFloat"),
        ("std", "parse_int") => Some("Bytes.parseInt"),
        ("std", "ucs2length") => Some("Bytes.ucs2Length"),
        ("std", "ucs2_lower") => Some("Bytes.lower"),
        ("std", "ucs2_upper") => Some("Bytes.upper"),
        ("std", "url_decode") => Some("Bytes.urlDecode"),
        ("std", "url_encode") => Some("Bytes.urlEncode"),
        ("std", "utf16_to_utf8") => Some("Bytes.utf16ToUtf8"),
        ("std", "utf8_to_utf16") => Some("Bytes.utf8ToUtf16"),
