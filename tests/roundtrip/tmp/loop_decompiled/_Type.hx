class $Type extends Class {
  ...
  // fun@293 (13 ops)
  dynamic function initClass(t: Class<Dynamic>, name: hl.Bytes): hl.Class {
    // alloc_obj@294
  ...
  // fun@296 (3 ops)
  dynamic function register(t: hl.BaseType) {
    // hbset@302
    hbset(@G24, b, t) /* fun@302 */;
  }

  // fun@297 (49 ops)
  dynamic function initEnum(t: Class<Dynamic>): hl.Enum {
    // alloc_obj@294
