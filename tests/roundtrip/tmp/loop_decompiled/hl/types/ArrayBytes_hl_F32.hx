...
class ArrayBytes_hl_F32 extends ArrayBase {
  var bytes: hl.Bytes;
  var size: Int;
  ...
  // fun@116 (32 ops)
  function concat(_: hl.types.ArrayBytes_hl_F32): hl.types.ArrayBytes_hl_F32 {
    var ac = new hl.types.ArrayBytes_hl_F32();
    ac = new hl.types.ArrayBytes_hl_F32();
    // __constructor__@150
    // nullcheck a
  ...
  function slice(end: Int, _: Null): hl.types.ArrayBase {
    ...
    if (0 > len) {
      // __constructor__@150
      return new hl.types.ArrayBytes_hl_F32();
    }
    var a = new hl.types.ArrayBytes_hl_F32();
    a = new hl.types.ArrayBytes_hl_F32();
    // __constructor__@150
    a.size = len;
    a.length = len;
    // sub@287
  ...
  function splice(len: Int, _: Int): hl.types.ArrayBase {
    ...
    var ret = new hl.types.ArrayBytes_hl_F32();
    ret = new hl.types.ArrayBytes_hl_F32();
    // __constructor__@150
    // sub@287
    var v0 = sub(this.bytes, pos << 2, len << 2) /* fun@287 */;
    ret.bytes = v0;
  ...
  // fun@128 (46 ops)
  function insert(x: Int, _: Single) {
    if (0 > pos) {
      pos = this.length + pos;
      if (0 > this.length + pos) {
        pos = 0;
  ...
  // fun@129 (8 ops)
  function contains(_: Single): Bool {
    // indexOf@131
  ...
  // fun@131 (28 ops)
  function indexOf(fromIndex: Single, _: Null): Int {
  ...
  // fun@132 (28 ops)
  function lastIndexOf(fromIndex: Single, _: Null): Int {
    var len = this.length;
  ...
  // fun@133 (21 ops)
  function copy(): hl.types.ArrayBytes_hl_F32 {
    var a = new hl.types.ArrayBytes_hl_F32();
    a = new hl.types.ArrayBytes_hl_F32();
    // __constructor__@150
    a.size = this.length;
  ...
  function iterator(): haxe.iterators.ArrayIterator {
    // __constructor__@373
    return new hl.types.BytesIterator_hl_F32(this);
  }

  // fun@135 (3 ops)
  function keyValueIterator(): haxe.iterators.ArrayKeyValueIterator {
    // __constructor__@376
    return new hl.types.BytesKeyValueIterator_hl_F32(this);
  }
  ...
  // fun@137 (19 ops)
  function filter(_: Function): hl.types.ArrayBytes_hl_F32 {
    var a = new hl.types.ArrayBytes_hl_F32();
    a = new hl.types.ArrayBytes_hl_F32();
    // __constructor__@150
    while (this.length > 0) {
