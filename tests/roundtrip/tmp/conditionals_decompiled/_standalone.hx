...
static function __constructor__(year: Date, month: Int, day: Int, hour: Int, min: Int, sec: Int, _: Int) {
  // date_new@216
  var v0 = date_new(year, month, day, hour, min, sec) /* fun@216 */;
  this.t = v0;
}
...
static function string(s: Dynamic): String {
  var len = 0;
  // value_to_string@224
  var bytes = value_to_string(s, len) /* fun@224 */;
  return new String();
}
...
static function __add__(a: Dynamic, b: Dynamic): Dynamic {
  ...
  // string@223
  var v4 = string(a) /* fun@223 */;
  // __add__@20
  var v5 = "Can't add " + v4;
  // __add__@20
  var v6 = v5 + "(";
  // string@223
  var v7 = string(ta) /* fun@223 */;
  // __add__@20
  var v8 = v6 + v7;
  // __add__@20
  var v9 = v8 + ") and ";
  // string@223
  var v10 = string(b) /* fun@223 */;
  // __add__@20
  var v11 = v9 + v10;
  // __add__@20
  var v12 = v11 + "(";
  // string@223
  var v13 = string(tb) /* fun@223 */;
  // __add__@20
  var v14 = v12 + v13;
  // __add__@20
  var v15 = v14 + ")";
  // thrown@226
  var v16 = thrown(v15) /* fun@226 */;
  throw v16;
}
...
static function fromCharCode(code: Int): String {
  ...
  // itos@227
  var v6 = itos(code, code) /* fun@227 */;
  // __alloc__@16
  var v7 = __alloc__(v6, code) /* fun@16 */;
  // thrown@226
  throw thrown(new String()) /* fun@226 */;
}
...
static function initEnum(et: Class<Dynamic>, t: Class<Dynamic>): hl.Enum {
  ...
  while (true) {
    if (cl.length > 0) {
      ...
      // ucs2length@229
      var v4 = ucs2length(name, 0) /* fun@229 */;
...
static function caught(value: Dynamic): haxe.Exception {
  // isOfType@222
  var v0 = isOfType(value, haxe.$Exception) /* fun@222 */;
  if (v0) {
    return value;
  }
  // __constructor__@311
...
static function formatOutput(v: Dynamic, infos: Dynamic): String {
  ...
  // itos@227
  var v1 = itos(infos.lineNumber, infos.lineNumber) /* fun@227 */;
  // __alloc__@16
  ...
  try {
    ...
    while (true) {
      if (stack.length - 1 > 0) {
        ...
        var s = new String();
        // ucs2length@229
        var v0 = ucs2length(stack[i], 0) /* fun@229 */;
    ...
    // alloc_array@271
    var v1 = alloc_array(haxe.io.Bytes, stack.length - skip) /* fun@271 */;
    // array_blit@315
...
static function String(_: hl.types.ArrayObj) {
  this.length = 0;
  // alloc_array@271
  var v0 = alloc_array(Dynamic, 0) /* fun@271 */;
  this.array = v0;
}
...
static function String() {
  init() /* fun@291 */;
  // initClass@293
  var v0 = initClass($Conditionals, Conditionals, "Conditionals") /* fun@293 */;
  // initClass@293
  var v1 = initClass($Date, Date, "Date") /* fun@293 */;
  // initClass@293
  var v2 = initClass($Std, Std, "Std") /* fun@293 */;
  @G60 = new hl.CoreType();
  // register@296
  ...
  // initClass@293
  var v3 = initClass($String, String, "String") /* fun@293 */;
  // initClass@293
  var v4 = initClass($StringBuf, StringBuf, "StringBuf") /* fun@293 */;
  // initClass@293
  ...
  @G73 = v14.__evalues__[0];
  @G74 = v14.__evalues__[1];
  @G43 = v14.__evalues__[2];
  // initClass@293
